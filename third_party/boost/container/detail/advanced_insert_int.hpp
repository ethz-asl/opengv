...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::std::container::uninitialized_move_alloc_n_source
         (this->a_, this->first_, n, p);
   }

   void copy_n_and_update(Iterator p, size_type n)
   {
      this->first_ = ::std::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   void uninitialized_copy_n_and_update(Iterator p, size_type n)
   {
      this->first_ = ::std::container::uninitialized_copy_alloc_n_source(this->a_, this->first_, n, p);
   }

   void copy_n_and_update(Iterator p, size_type n)
   {
      this->first_ = ::std::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  std::container::uninitialized_fill_alloc_n(this->a_, v_, n, p);  }
...
{
   typedef ::std::container::allocator_traits<A> alloc_traits;
   typedef typename allocator_traits<A>::size_type size_type;
   typedef typename allocator_traits<A>::value_type value_type;
   ...
   void uninitialized_copy_n_and_update(Iterator p, size_type n) const
   {  std::container::uninitialized_default_alloc_n(this->a_, n, p);  }
...
struct insert_non_movable_emplace_proxy
{
   ...
   void priv_uninitialized_copy_some_and_update(const index_tuple<IdxPack...>&, Iterator p, size_type n)
   {
      ...
      alloc_traits::construct( this->a_
                              , container_detail::to_raw_pointer(&*p)
                              , ::std::forward<Args>(get<IdxPack>(this->args_))...
                              );
   }
   ...
   :  public insert_non_movable_emplace_proxy<A, Iterator, Args...>
{
   ...
   explicit insert_emplace_proxy(A &a, Args&&... args)
      : base_t(a, ::std::forward<Args>(args)...)
   {}
