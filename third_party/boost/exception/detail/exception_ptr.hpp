...
boost
    ...
    exception_ptr
        {
        typedef std::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, std::exception const & e2 ):
                T(e1),
                std::exception(e2)
                {
                add_original_type(e1);
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<std::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( std::exception const * e2 = get_boost_exception(&e1) )
                return std::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return std::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return std::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( std::exception const & e )
            {
            return std::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( std::exception const * be = get_boost_exception(&e) )
