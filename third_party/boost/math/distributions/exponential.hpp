...
public:
   ...
   {
      RealType err;
      detail::verify_lambda("std::math::exponential_distribution<%1%>::exponential_distribution", lambda, &err, Policy());
...
inline RealType pdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "std::math::pdf(const exponential_distribution<%1%>&, %1%)";
...
inline RealType cdf(const exponential_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "std::math::cdf(const exponential_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::verify_exp_x(function, x, &result, Policy()))
      return result;
   result = -std::math::expm1(-x * lambda, Policy());
...
inline RealType quantile(const exponential_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "std::math::quantile(const exponential_distribution<%1%>&, %1%)";
   ...
   result = -std::math::log1p(-p, Policy()) / lambda;
   return result;
} // quantile
...
inline RealType mean(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("std::math::mean(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
...
inline RealType standard_deviation(const exponential_distribution<RealType, Policy>& dist)
{
   RealType result = 0;
   RealType lambda = dist.lambda();
   if(0 == detail::verify_lambda("std::math::standard_deviation(const exponential_distribution<%1%>&)", lambda, &result, Policy()))
      return result;
   return 1 / lambda;
}
