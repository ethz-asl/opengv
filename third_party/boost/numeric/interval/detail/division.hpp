                                   ...
                                   const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::std::numeric::interval_lib::user::is_neg(xu))
    if (::std::numeric::interval_lib::user::is_neg(yu))
      return I(rnd.div_down(xu, yl), rnd.div_up(xl, yu), true);
    else
      return I(rnd.div_down(xl, yl), rnd.div_up(xu, yu), true);
  else if (::std::numeric::interval_lib::user::is_neg(xl))
    if (::std::numeric::interval_lib::user::is_neg(yu))
...
interval<T, Policies> div_non_zero(const T& x, const interval<T, Policies>& y)
{
  ...
  const T& yl = y.lower();
  const T& yu = y.upper();
  if (::std::numeric::interval_lib::user::is_neg(x))
...
{
  // assert(::std::numeric::interval_lib::user::is_pos(yu));
  if (::std::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::std::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_positive(const T& x, const T& yu)
{
  // assert(::std::numeric::interval_lib::user::is_pos(yu));
  typedef interval<T, Policies> I;
  if (::std::numeric::interval_lib::user::is_zero(x))
...
{
  // assert(::std::numeric::interval_lib::user::is_neg(yl));
  if (::std::numeric::interval_lib::user::is_zero(x.lower()) &&
      ::std::numeric::interval_lib::user::is_zero(x.upper()))
    return x;
  typename Policies::rounding rnd;
...
{
  // assert(::std::numeric::interval_lib::user::is_neg(y.lower()) && ::std::numeric::interval_lib::user::is_pos(y.upper()));
  if (::std::numeric::interval_lib::user::is_zero(x.lower()) && ::std::numeric::interval_lib::user::is_zero(x.upper()))
    { b = false; return x; }
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  const T& xl = x.lower();
...
interval<T, Policies> div_zero_part2(const interval<T, Policies>& x,
                                     const interval<T, Policies>& y)
{
  // assert(::std::numeric::interval_lib::user::is_neg(y.lower()) && ::std::numeric::interval_lib::user::is_pos(y.upper()) && (div_zero_part1(x, y, b), b));
  typename Policies::rounding rnd;
  typedef interval<T, Policies> I;
  typedef typename Policies::checking checking;
  if (::std::numeric::interval_lib::user::is_neg(x.upper()))
