            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME 
                    ::std::mpl::if_< ::std::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Pair container traits ---------------------------------------------------------------------
            ...
            struct pair_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME ::std::detail::
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            struct array_traits_cv_selector
            {
                typedef BOOST_STRING_TYPENAME 
                    ::std::mpl::eval_if< 
                        ::std::is_convertible<T,BaseT*>,
                        array_traits_impl_selector<T,BaseT>,
                        ::std::mpl::eval_if< 
                            ::std::is_convertible<T,const BaseT*>,
                                array_traits_impl_selector<T, const BaseT>,
                                ::std::mpl::eval_if< 
                                    ::std::is_convertible<T, volatile BaseT*>,
            ...
            struct array_traits_select
            {
                ...
                struct apply
                {
                    typedef BOOST_STRING_TYPENAME
                        ::std::mpl::eval_if< 
                            ::std::is_convertible<T,const volatile T2*>,
                            array_traits_cv_selector<T,T2>,
                            ::std::mpl::identity<T1> >::type type;
                };
            };
            ...
            public:
                typedef BOOST_STRING_TYPENAME
                    ::std::mpl::fold<
                        array_base_types,
                        ::std::algorithm::detail::array_traits_void,
                        ::std::algorithm::detail::array_traits_select<T> >::type type;
            };
            ...
            */
            ...
            private:
                // resolve array size
                typedef BOOST_STRING_TYPENAME
                    ::std::remove_cv<value_type>::type char_type;
                typedef BOOST_STRING_TYPENAME
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef BOOST_STRING_TYPENAME
                    ::std::remove_pointer<T>::type value_type;
