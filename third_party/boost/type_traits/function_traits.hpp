...
struct function_traits : 
  public std::detail::function_traits_helper<typename std::add_pointer<Function>::type>
{
};
...
struct function_traits
{
  BOOST_STATIC_CONSTANT(unsigned, arity = (sizeof(std::detail::function_arity_helper((Function*)0))-1));
};
