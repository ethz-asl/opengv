...
struct has_trivial_move_assign_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
           (::std::type_traits::ice_and<
              ::std::is_pod<T>::value,
              ::std::type_traits::ice_not< ::std::is_const<T>::value >::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_move_assign,T,::std::detail::has_trivial_move_assign_impl<T>::value)
