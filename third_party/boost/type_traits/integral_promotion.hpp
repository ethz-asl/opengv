...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(std::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(std::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, std::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, std::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, std::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, std::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (std::type_traits::detail::promoted_index<T>::value)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        std::type_traits::detail::integral_promotion<T>::type
    )
}
