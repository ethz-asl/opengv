...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::std::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::std::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,std::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,std::uint128_type,true)
#endif
