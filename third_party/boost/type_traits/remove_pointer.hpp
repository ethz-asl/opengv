...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename std::detail::remove_pointer_imp2<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename std::detail::remove_pointer_impl<T>::type)
